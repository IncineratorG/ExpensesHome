...
import com.costs.newcosts.common.sms.SmsExpensesReader;
import com.costs.newcosts.common.sms.provider.SmsProvider;
import com.costs.newcosts.common.sms.provider.providers.mkb.MkbSmsProvider;
import com.costs.newcosts.common.sms.provider.providers.sberbank.SberbankSmsProvider;
...
public class ActivitySmsExpensesReader
    ...
    private SmsExpensesReader mSmsExpensesReader;
...
//        getSupportLoaderManager().initLoader(LOADER_ID, null, this);
        ...
        smsProviders.add(new SberbankSmsProvider());
//        smsProviders.add(new MkbSmsProvider());

        mSmsExpensesReader = new SmsExpensesReader(
                this,
                smsProviders,
                result -> {
                    Log.d(TAG, "==> smsExpenseReader->resultCallback() <== " + String.valueOf(result.size()));

                    for (int i = 0; i < result.size(); ++i) {
                        DataUnitSms smsData = result.get(i).smsData();
                    ...
                    smsReaderRecyclerViewAdapter.setClickListener((itemView, position) -> {
                        ...
                        String expenseValueString = result.get(position).expenseValue();
                        String expenseNoteString = result.get(position).expenseNote();
...
//            getSupportLoaderManager().initLoader(LOADER_ID, null, this);
            ...
            // ===
            // =====
            mSmsExpensesReader.read(getSupportLoaderManager());
            // =====
            // ===
        }
    }
...
//                    System.out.println("PERMISSION_DENIED");
    ...
    public void onLoadFinished(Loader<Cursor> loader, final Cursor data) {
        Log.d(TAG, "onLoadFinished()->LOADER_ID: " + String.valueOf(loader.getId()));
    ...
    public void getSmsReaderDialogResult(boolean savedInDB, String value) {
        Log.d(TAG, "getSmsReaderDialogResult(): " + String.valueOf(savedInDB));
...
//            smsProviders.add(new MkbSmsProvider());
//
//            SmsExpensesReader smsExpensesReader = new SmsExpensesReader(
//                    this,
//                    smsProviders,
//                    result -> {
//                        Log.d(TAG, "==> smsExpenseReader->resultCallback() <==");
//                    }
//            );
//            smsExpensesReader.read(getSupportLoaderManager());
//            // =====
//            // ===
//        }
//
